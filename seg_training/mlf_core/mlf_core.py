...
def log_conda_environment(reports_output_dir: str):
    ...
    conda_env_filehandler = open(f'{reports_output_dir}/seg_training_conda_environment.yml', "w")
    ...
    mlflow.log_artifact(f'{reports_output_dir}/seg_training_conda_environment.yml', artifact_path='reports')
