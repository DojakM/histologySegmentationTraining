...
from data_loading import ConicDataModule
...
if __name__ == "__main__":
    ...
    model = Unet(3, 7)
    model = model(5, len_test_set=len(dm.df_test), hparams=parser.parse_args(), input_channels=3, min_filter=64,
                  **dict_args)
    ...
    if 'MLF_CORE_DOCKER_RUN' in os.environ:
        checkpoint_callback = ModelCheckpoint(dirpath="seg_training/mlruns/0", save_top_k=0, verbose=True,
